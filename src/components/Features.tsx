...
<section className="bg-yellow-300 dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">Recevez nos actualités, interventions et conseils sur la promotion de la paix  directement dans votre boîte email.</p>
          <form action="#">
